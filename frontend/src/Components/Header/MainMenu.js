  ...
  return (
    <>
      <div className="flex h-fit bg-white justify-between text-paragraph">
        <div>
          <img src={MetroLogo} className="h-39px my-3 ml-12 mr-5" />
        </div>
        <div className="flex h-fit   my-auto gap-8 mr-40 ">
          <div className=" hover:text-red2 group  pt-2 pb-3 w-16">
            <p className="text-center"> Rental </p>
            <img
              src={Arrow}
              className="ml-2 mt-2 absolute hidden group-hover:block "
            />
            <div className="hidden group-hover:block absolute  left-0 top-16 mt-2 w-full ">
              <RentalsMenu />
            </div>
          </div>
          ...
          <div className=" hover:text-red2 group pt-2 pb-3   w-28">
            ...
            <img
              src={Arrow}
              className="ml-8 mt-2 absolute hidden group-hover:block"
            />
            <div className="hidden group-hover:block absolute  left-0 top-16 mt-2 w-full">
              <InvestmentSubMenu />
            </div>
          ...
          <div className=" hover:text-red2 group pt-2 pb-3 w-44">
            ...
            <img
              src={Arrow}
              className="ml-16 mt-2 absolute hidden group-hover:block"
            />
            <div className="hidden group-hover:block absolute  left-0 top-16 mt-2 w-full">
          ...
          <div className=" hover:text-red2 group pt-2 pb-3 w-16">
            ...
            <img
              src={Arrow}
              className="ml-3 mt-2 absolute hidden group-hover:block"
            />
        ...
        <div className="flex mr-16 my-auto text-paragraph group">
          <button className="text-red2 font-bold border-red2 border w-28 h-9 px-0 rounded mr-4">
            Customer Login
          </button>
          <button className="bg-red2 text-white rounded w-28 h-9 ">
            My Diary
          </button>
        </div>
      </div>
